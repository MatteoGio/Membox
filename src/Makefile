...
# 
FILE_DA_CONSEGNARE=membox.c membox.h read_write.c read_write.h connections.c connections.h errors.c errors.h queue.c queue.h icl_hash.c icl_hash.h message.h ops.h stats.h stat.sh client.c DATA/membox.conf1 DATA/membox.conf2
# inserire il nome del tarball: es. NinoBixioGiuseppeGaribaldi
TARNAME=GiorgiMatteo_QuartaAndrea_f2
#
###########################################################
